                    ...
                    <div id ="user_list_card" class="card-body"> 
                        ...
                        <div class="row">
                            <div class="col-md-6 center">
                                ...
                                <form role="form" id="form_edit_department" method="POST" action="{{url("/admin/departments/edit/{$departments->id}")}}"> 
                                    <div class="form-group">
                                        <label>ชื่อแผนก</label>
                                        <div class="input-group input-group-alternative">
                                            <input class="form-control" placeholder="ชื่อแผนก" name = "department_name" type="text" value="{{$departments->name}}"> 
                                        </div>
                                    </div>   
...
<script>
    ...
    validator = $('#form_edit_department').validate({
        focus: function () {
