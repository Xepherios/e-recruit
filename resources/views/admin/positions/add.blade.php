                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">เพิ่มตำแหน่งงาน</h3>
                            </div> 
                        </div>
                    </div>
                    <div id ="user_list_card" class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 center"> 
                                <form role="form" id="form_add_position" method="POST" action="{{url('/admin/positions/add')}}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            <textarea class="form-control form-control-alternative" rows="3" name="description"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>คุณสมบัติผู้สมัคร</label>
                                        <textarea class="form-control form-control-alternative" rows="3" name="qualification"></textarea>
                                    </div>
                                    
                                    <div class="form-group mb-3">
                                        <label>เงินเดือนขั้นต่ำ</label>
                                        <div class="input-group input-group-alternative"> 
                                            <input class="form-control" placeholder="" name = "min_salary" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>เงินเดือนสูงสุด</label>
                                        <div class="input-group input-group-alternative"> 
                                            <input class="form-control" placeholder="" name = "max_salary" type="text">
                                        </div>
                                    </div>
...
@section('footer')
    ...
    <script>
        ...
        position_validator = $('#form_add_position').validate({
            focus: function () {
